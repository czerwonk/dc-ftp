...
public class FtpClientWithSkeySupport extends TransferProtocolClient {
     ...
     */
    public FtpClientWithSkeySupport(String host) throws IOException {
        super();
        openServer(host, FTP_PORT);
    }
     ...
     * @exception FtpProtocolException if the connection fails
     */
    public FtpClientWithSkeySupport(String host, int port) throws IOException {
        super();
        openServer(host, port);
    }

    /** Create an uninitialized FTP client. */
    public FtpClientWithSkeySupport() {}

    public FtpClientWithSkeySupport(Proxy p) {
        proxy = p;
    }
